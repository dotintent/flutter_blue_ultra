...
A common platform interface for the [`flutter_blue_ultra`][1] plugin.

This interface allows platform-specific implementations of the `flutter_blue_ultra`
plugin, as well as the plugin itself, to ensure they are supporting the
same interface.

# Usage

To implement a new platform-specific implementation of `flutter_blue_ultra`, extend
...
[1]: ../flutter_blue_ultra
[2]: lib/flutter_blue_ultra_platform_interface.dart

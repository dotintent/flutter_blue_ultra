...
/// The interface that implementations of flutter_blue_ultra must implement.
abstract base class FlutterBlueUltraPlatform {
  static FlutterBlueUltraPlatform? _instance;

  /// The default instance of [FlutterBlueUltraPlatform] to use. Throws an [UnsupportedError] if flutter_blue_ultra is unsupported on this platform.
  static FlutterBlueUltraPlatform get instance {
    ...
    if (instance != null) {
      ...
      throw UnsupportedError(
        'flutter_blue_ultra is unsupported on this platform',
      );
    }
  }

  /// Platform-specific plugins should set this with their own platform-specific class that extends [FlutterBlueUltraPlatform] when they register themselves.
  static set instance(
    FlutterBlueUltraPlatform instance,
  ) {
    _instance = instance;
  }
